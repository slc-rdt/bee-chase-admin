...
interface ISubmissionsViewByTeamVerificationType {
  currentPage: number;
  submissionsPaginated: PaginateResponseDto<Submission>;
  onDelete: (submission: Submission) => Promise<void>;
}

const SubmissionsViewByTeamVerificationType: ComponentType<
  ComponentProps<"div"> & ISubmissionsViewByTeamVerificationType
...
export default SubmissionsViewByTeamVerificationType;
